---
title: "Figure 7: Integrative analysis (F7, S17-19)"
format:
  html:
    toc: true
    code-fold: true
...
![](figures-png/figure-s17-mefisto.png)

## Supplementary Figure 18

![](figures-png/figure-s18.png)

## Supplementary Figure 19

![](figures-png/figure-s19.png)
...
```{r sourcedata.histogram}
a$data |> dplyr::select(p) |>
  write.table(quote = F, sep = "\t", row.names = F, col.names = T,
                   file = 'srcdata/s18a.txt')
...
ggsave(a, filename = 'out/pdf/s18a.pdf', width = 3, height = 3)
ggsave(b, filename = 'out/pdf/s18b.pdf', width = 3, height = 3)
ggsave(c, filename = 'out/pdf/s18c.pdf', width = 3, height = 3)
ggsave(d, filename = 'out/pdf/s18d.pdf', width = 3, height = 3)
ggsave(e, filename = 'out/pdf/s18e.pdf', width = 4.5, height = 3)
ggsave(f, filename = 'out/pdf/s18f.pdf', width = 4.5, height = 3)
ggsave(g, filename = 'out/pdf/s18g.pdf', width = 5.75, height = 7)
ggsave(h, filename = 'out/pdf/s18h.pdf', width = 5.75, height = 7)
ggsave(i, filename = 'out/pdf/s18i.pdf', width = 4.5, height = 3.5)
...
cairo_pdf(here("out/pdf/s19.pdf"), width = 11, height = 9)
multi_network_diagram(features = features,
                      seed = 3,
                      corrObj = corrObj2,
                      expand = F,
