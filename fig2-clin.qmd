...
Initially, we illustrate main clinical changes to key variables, such as body mass index, fat mass, subcutaneous fat, or other variables related with cardiovascular activity and health (VO_2 max, HDL).
...
# G: SCfat  --------------
g <- paired_longitudinal_compliance(df_raw, 'scfat', p = 'p.signif',
                                    nn = 2,
                               ylab = "<b>subcutaneous fat</b><br>(mm)",
                               filter_high = T)
# H: VO2Max --------------
h <- paired_longitudinal_compliance(df_raw, 'vo2max', p = 'p.signif',
                                    nn = 2,
                                    ylab = "<b>VO<sub>2</sub>max</b><br>(ml/min/kg)",
                               filter_high = T)

# I: Relmax cap --------------
i <- paired_longitudinal_compliance(df_raw, 'relmaxcap', p = 'p.signif',
                                            nn = 2,
                                            ylab = "<b>relative power at peak HR</b><br>(W/kg)",
                                            filter_high = T) 

# J: HDL --------------
j <- paired_longitudinal_compliance(df_raw, 'hdl', p = 'p.signif',
                                    nn = 2,
                                    ylab = "<b>HDL cholesterol</b><br>(mg/dL)",
                               filter_high = T)

# K: LDL --------------
k <- paired_longitudinal_compliance(df_raw, 'ldl', p = 'p.signif',
                                    nn = 2,
                                    ylab = "<b>LDL cholesterol</b><br>(mg/dL)",
                               filter_high = T)

# L: LDH --------------
l <- paired_longitudinal_compliance(df_raw, 'ldh', p = 'p.signif',
                                    nn = 2,
...
p <- plot_lmm_heatmap_v3(lmm_data_time = out_lmm$`Minimal model`,
...
cairo_pdf("out/pdf/2k.pdf", width = 7, height = 8.25)
print(p)
dev.off()
```
...
a <- paired_longitudinal_compliance(df_change, 'scfat',
                               nn = 2,
                               ylab = '<b>∆ subcutaneous fat</b><br>(mm)')
b <- comparison_plots(df_change, 'scfat', nn = 2, ylab = '<b>∆ subcutaenous fat</b><br>(mm)')

c <- paired_longitudinal_compliance(df_change, 'vifat',
                               nn = 2,
                               ylab = '<b>∆ visceral fat</b><br>(mm)')
d <- comparison_plots(df_change, 'vifat', nn = 2, ylab = '<b>∆ visceral fat</b><br>(mm)')

e <- paired_longitudinal_compliance(df_change, 'ecw',
                               nn = 4,
                               ylab = '<b>∆ extracellular water</b><br>(%)',
                               p = 'p.signif')
f <- comparison_plots(df_change, 'ecw', nn = 4, ylab = '<b>∆ extracellular water</b><br>(%)')

g <- paired_longitudinal_compliance(df_change, 'bcm',
                               nn = 4,
                               ylab = '<b>body cellular mass</b><br>(%)',
                               p = 'p.signif')
h <- comparison_plots(df_change, 'bcm', nn = 4, ylab = '<b>∆ body cellular mass</b><br>(%)')

i <- paired_longitudinal_compliance(df_change, 'vo2max',
                               nn = 2,
                               ylab = '<b>∆ VO<sub>2</sub>peak</b><br>(ml/min/kg)')
j <- comparison_plots(df_change, 'vo2max', nn = 2, ylab = '<b>∆ VO<sub>2</sub>peak</b><br>(ml/min/kg)')

k <- paired_longitudinal_compliance(df_change, 'hdl',
                               nn = 2,
                               ylab = '<b>∆ HDL cholesterol</b><br>(mg/dL)')

l <- comparison_plots(df_change, 'hdl', nn = 2, ylab = '<b>∆ HDL cholesterol</b><br>(mg/dL)')

m <- paired_longitudinal_compliance(df_change, 'ldl',
                               nn = 2,
                               ylab = '<b>∆ LDL cholesterol</b><br>(mg/dL)')

n <- comparison_plots(df_change, 'ldl', nn = 2, ylab = '<b>∆ LDL cholesterol fat</b><br>(mg/dL)')


o <- paired_longitudinal_compliance(df_change, 'alat',
                               nn = 2,
                               ylab = '<b>∆ ALAT</b><br>(U/L)')

p <- comparison_plots(df_change, 'alat', nn = 2, ylab = '<b>∆ ALAT</b><br>(U/L)')

q <- paired_longitudinal_compliance(df_change, 'uricacid',
                               nn = 2,
                               ylab = '<b>∆ uric acid</b><br>(U/L)')
r <- comparison_plots(df_change, 'uricacid', nn = 2, ylab = '<b>∆ uric acid</b><br>(mg/dL)')


s <- paired_longitudinal_compliance(df_change, 'ethickum',
                                    nn = 2,
...
cairo_pdf("figures-pdf/e3.pdf", width = 12, height = 20)
print(plot)
dev.off()
...
```{r}
cairo_pdf(here("figures-pdf/e4-iron.pdf"), width = 8, height = 12.5)
print(plot)
dev.off()

ggsave(plot = plot, filename = here("figures-png/e4-iron.png"), width = 8, height = 13,  unit = 'in',
       dpi = 300)
