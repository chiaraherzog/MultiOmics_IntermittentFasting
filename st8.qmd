---
title: "LME (interaction) (ST8)"
format:
  html:
    toc: true
---

Supplementary Table 8 is the output of linear mixed-effects models run on high compliance individuals, assessing the impact of intervention, in the [helper-lme](helper-lmm.qmd) script using the model `(value ~ age at consent + smoking pack years + visitId*interventionId + (1|subjectId)`.
