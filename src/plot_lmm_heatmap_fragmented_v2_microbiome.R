...
#' @param lmm_data_time Model that provides time coefficient (no interaction) (out_lmm$`Minimal model` or out_lmm$`Intervention (higher compliance)`)
...
# main function
plot_lmm_heatmap_frag_v2 <- function(exp,
                                  lmm_data_time,
                                  lmm_data_int,
                                  cols = c("#1b69a1",
                                           "#48a0af",
