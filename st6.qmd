...
Supplementary Table 6 is the output of linear mixed-effects models run on all complete cases in the [helper-lme](helper-lmm.qmd) script using the model `(value ~ age at consent + bmi at consent + visitId + (1|subjectId)`.
