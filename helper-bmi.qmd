---
title: "baseline features ~ follow-up BMI change (S15)"
format:
  html:
    toc: true
    code-fold: true
...
ggsave(filename = 'figures-png/figure-s15-dbmi.png',width = 3.5, height = 3.5, plot = p)
```

```{r sourcedata.s15}
p$data |> dplyr::select(value, dbmi) |> 
  write.table(quote = F, sep = "\t", row.names = F, col.names = T,
                   file = 'srcdata/s15.txt')
...
writexl::write_xlsx(assoc_clean, path = here("out/Supplementary-Table-S12.xlsx"))
